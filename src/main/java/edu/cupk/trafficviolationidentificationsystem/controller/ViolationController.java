...
public class ViolationController {
     ...
     */
    @GetMapping
    public PageResultDto<ViolationDetailDto> getViolations(ViolationQueryDto queryDto) {
        // 不再是返回固定的模拟数据，而是调用服务层来获取真实数据
        return violationService.listViolations(queryDto);
    }
}